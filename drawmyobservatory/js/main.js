...
var Rappid = Backbone.Router.extend({
    ...
    initializePaper: function() {
        ...
        $.get(OC.filePath('drawmyobservatory','forms','model'), function(data) {
            ajaxTemplate = data;
        });
        ...
        $.ajax({
         url: OC.generateUrl('/apps/drawmyobservatory/ajax/filecontents.php?file=' + filename + '&dir='+ dir +'&user='+ user),
                    ...
                    Save: function() {
                        ...
                        for (var i in toImport) {
                            ...
                            $.ajax({
                                ...
                                url: webdavPath + toImport[i].attrs.text.text + ".moe",
                                type: 'PUT',
                                xhrFields: {
                                    withCredentials: true
                                },
        ...
        $("li.save").on('click', _.bind(function() {
            ...
            if (choice == 0) {
                ...
                for (var i in toImport) {
                    ...
                    zip.file(toImport[i].attrs.text.text + ".moe", JSON.stringify({
                        "cells": [toImport[i]]
                    }));
    ...
    initializeAjaxRequests: function() {
        ...
        var reqModel = $.ajax({
            ...
            url: OC.filePath('drawmyobservatory', 'models',''),
            success: function(data) {
                ...
                $(data).find("a").each(function(index) {
                    ...
                    if (filename.substr(filename.lastIndexOf('.') + 1) === "json") {
                        var urlModel = OC.filePath('drawmyobservatory', 'models',filename);
                        reqModels[index] = $.ajax({
                            ...
                            success: function(a) {
                                ...
                                if(shape != null){
                                    ...
                                    shape.attrs.image['xlink:href']=OC.imagePath('drawmyobservatory', 'models/'+imageFileName);
